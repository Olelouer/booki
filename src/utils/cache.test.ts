...
const data: GoogleBook[] = [
  {
    id: "fD1VEAAAQBAJ",
    volumeInfo: {
      title: "Harry Potter et l'Histoire",
  ...
  },
  {
    id: "YjxVEAAAQBAJ",
    volumeInfo: {
      title: "Agir et penser comme Harry Potter",
  ...
  },
  {
    id: "jLm9EQAAQBAJ",
    volumeInfo: {
      title: "Harry Potter. À l'école des sciences morales et politiques",
...
const zolaData: GoogleBook[] = [
  {
    id: "sLkeCwAAQBAJ",
    volumeInfo: {
      title: "Emile Zola - Les oeuvres complètes (édition augmentée)",
